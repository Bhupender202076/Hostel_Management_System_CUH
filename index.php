...
<div class="HeroContent">
  ...
  <p class="HeroP">Central University of Haryana</p>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="pricing.php" class="FooterLink">Hostels</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">Central University of Haryana © 2023</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/profile.php?id=100067333404164" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/cuhofficial?lang=en" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/cuh_official/" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/c/centraluniversityofharyana" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
